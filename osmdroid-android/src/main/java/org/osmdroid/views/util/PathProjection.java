...
public class PathProjection {
    ...
    public static Path toPixels(Projection projection, final List<? extends GeoPoint> in,
        ...
        for (final GeoPoint gp : in) {
            ...
            final double mapSizeX = TileSystem.MapSizeX(projection.getZoomLevel());
            final double mapSizeY = TileSystem.MapSizeY(projection.getZoomLevel());
            final PointL mercator = tileSystem.getMercatorFromGeo(
                    gp.getLatitude(), gp.getLongitude(), mapSizeX, mapSizeY,
                    null, true);
            ...
            final GeoPoint neGeoPoint = tileSystem.getGeoFromMercator(upperRight.x, upperRight.y, mapSizeX, null, true, true);
            final GeoPoint swGeoPoint = tileSystem.getGeoFromMercator(lowerLeft.x, lowerLeft.y, mapSizeX, null, true, true);
